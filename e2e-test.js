...
async function runE2ETests() {
  ...
  try {
    ...
    console.log('✅ Registration API:', registerData.success ? 'SUCCESS' : 'FAILED');
    ...
    try {
      ...
      const loginPageExists = await page.locator('input[type="email"]').isVisible();
      console.log('✅ React Login page:', loginPageExists ? 'ACCESSIBLE' : 'NOT FOUND');
    ...
    try {
      ...
      console.log('✅ Angular Content:', hasContent.includes('Error') ? 'HAS ERRORS' : 'LOADED');
