...
async function runFinalE2ETest() {
  ...
  try {
    ...
    if (loginData.success) {
      ...
      console.log('   🔐 Permissions:', loginData.data.permissions.length, 'permissions loaded');
    }
    ...
    if (registerData.success) {
      ...
      console.log('   ✉️ Email Verification:', registerData.data.requiresVerification ? 'Required' : 'Not Required');
